...
const statusquestions = [
    ...
    },
    {
        type: 'list',
        name: 'selstatus',
        message: 'Change the status of the bot: ',
        choices: ['online', 'idle', 'dnd']
    }
]

//#region Messages questions
const msgtypethingy = [
    {
        type: 'list',
        name: 'msgtype',
...
const changeembedcolorquest = [
    {
        type: 'input',
        name: 'newdefembedcolor',
        message: 'Type a new default embed color (ONLY HEX) '
    }
]
